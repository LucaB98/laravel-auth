    ...
    <div class="row">
        ...
        <div class="col-11">
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="image" name="image" placeholder="http:..." value="{{old('image', '')}}">
            </div>
        </div>
        <div class="col-1">
            <div class="mb-3">
                <img src="https://marcolanci.it/boolean/assets/placeholder.png" class="img-fluid" alt="img" id="preview">
            </div>
        </div>
        <div class="col-12 d-flex justify-content-end">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="1" id="is_published" name="is_published" @if(old('is_published', '')) checked @endif>
